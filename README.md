...
When downloading mods from [Nexus Mods](https://nexusmods.com)(most known modding website), you have to manually click on a download button every time a new mod is added to the queue.
